...
public class MachineASous {
    ...
    public MachineASous() {        rouleaux = new ArrayList < > ();
         ...
         // Vérifier si le joueur a gagné une somme d'argent ou perdu
            ...
            for (int i = 0; i < countSymboles.length; i++) {
                if (countSymboles[i] >= 3) {
                    switch (i) {
                        case 0: multiplicateurGain = 5; break;
                        case 1: multiplicateurGain = 4; break;
                        case 2: multiplicateurGain = 3; break;
                        case 3: multiplicateurGain = 6; break;
                        case 4: multiplicateurGain = 5; break;
                        case 5: multiplicateurGain = 5; break;
                        case 6: multiplicateurGain = 5; break;
                        case 7: multiplicateurGain = 5; break;
                        case 8: multiplicateurGain = 5; break;
                    }
